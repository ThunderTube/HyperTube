        ...
        <li class="mb-10">
          <a href="#" class="text-gray-500 hover:text-white">
            <svg 
              ...
              width="24" 
              height="24">
              <path d="M9 22H5a1 1 0 0 1-1-1V11l8-8 8 8v10a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1v-4a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v4a1 1 0 0 1-1 1zm3-9a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" class="primary"></path><path d="M12.01 4.42l-8.3 8.3a1 1 0 1 1-1.42-1.41l9.02-9.02a1 1 0 0 1 1.41 0l8.99 9.02a1 1 0 0 1-1.42 1.41l-8.28-8.3z">
              </path>
            </svg>
          </a>
        </li>
        <li class="mb-10">
          <a href="#" class="text-gray-500 hover:text-white">
           <svg 
            ...
            width="24" 
            height="24">
            <path fill-rule="evenodd" d="M17 11a1 1 0 0 1 0 2h-4v4a1 1 0 0 1-2 0v-4H7a1 1 0 0 1 0-2h4V7a1 1 0 0 1 2 0v4h4z">
            </path>
           </svg>
          </a>
        </li>
